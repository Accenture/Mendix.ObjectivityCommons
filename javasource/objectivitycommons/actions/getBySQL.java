 ...
 */
public class getBySQL extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private com.mendix.systemwideinterfaces.javaactions.parameters.IStringTemplate Sql;
	private java.lang.String ResultEntity;

	public getBySQL(IContext context, com.mendix.systemwideinterfaces.javaactions.parameters.IStringTemplate Sql, java.lang.String ResultEntity)
	{
		super(context);
		this.Sql = Sql;
