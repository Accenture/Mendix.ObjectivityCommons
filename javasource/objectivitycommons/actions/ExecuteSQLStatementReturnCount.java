 ...
 */
public class ExecuteSQLStatementReturnCount extends CustomJavaAction<java.lang.Long>
{
	private com.mendix.systemwideinterfaces.javaactions.parameters.IStringTemplate Sql;

	public ExecuteSQLStatementReturnCount(IContext context, com.mendix.systemwideinterfaces.javaactions.parameters.IStringTemplate Sql)
	{
		super(context);
		this.Sql = Sql;
	}
	...
	{
		return "ExecuteSQLStatementReturnCount";
	}
