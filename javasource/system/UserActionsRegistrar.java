...
public class UserActionsRegistrar
{
  public void registerActions(IActionRegistrator registrator)
  {
    ...
    registrator.registerUserAction(objectivitycommons.actions.CloneIgnoreSystemAttributes.class);
    registrator.registerUserAction(objectivitycommons.actions.CommitInSeparateDatabaseTransactionWithoutEvent.class);
    registrator.registerUserAction(objectivitycommons.actions.CSV_ReadNextLine_ToEntity.class);
    registrator.registerUserAction(objectivitycommons.actions.CSV_ReadNextLine_ToStringList.class);
    registrator.registerUserAction(objectivitycommons.actions.CSV_WriteNextLine_FromEntity.class);
    registrator.registerUserAction(objectivitycommons.actions.CSV_WriteNextLine_FromStringList.class);
    registrator.registerUserAction(objectivitycommons.actions.ExecuteSQLStatement.class);
    registrator.registerUserAction(objectivitycommons.actions.ExecuteSQLStatementReturnCount.class);
    registrator.registerUserAction(objectivitycommons.actions.ExportOQLToJSON.class);
    registrator.registerUserAction(objectivitycommons.actions.GetAttributeValueAsString.class);
    registrator.registerUserAction(objectivitycommons.actions.GetTypeAsString.class);
    registrator.registerUserAction(objectivitycommons.actions.JSON_Array_GetByKey.class);
    registrator.registerUserAction(objectivitycommons.actions.JSON_Array_GetKeyValuePairs.class);
    registrator.registerUserAction(objectivitycommons.actions.JSON_Object_GetByKey.class);
    registrator.registerUserAction(objectivitycommons.actions.JSON_Object_GetKeyValuePairs.class);
    registrator.registerUserAction(objectivitycommons.actions.ListDistinct.class);
    registrator.registerUserAction(objectivitycommons.actions.ListMap.class);
    registrator.registerUserAction(objectivitycommons.actions.ListShuffle.class);
    registrator.registerUserAction(objectivitycommons.actions.ListTake.class);
    registrator.registerUserAction(objectivitycommons.actions.Logout.class);
    registrator.registerUserAction(objectivitycommons.actions.RetrieveEnhanced.class);
    registrator.registerUserAction(objectivitycommons.actions.RetrieveEnhancedWithTotalRows.class);
    registrator.registerUserAction(objectivitycommons.actions.RetrieveFromList.class);
    registrator.registerUserAction(objectivitycommons.actions.RetrieveLong.class);
    registrator.registerUserAction(objectivitycommons.actions.RetrieveObjectByGuid.class);
    ...
    registrator.registerUserAction(objectivitycommons.actions.StringJoinByTemplate.class);
    ...
    registrator.registerUserAction(objectivitycommons.actions.URLEncode.class);
